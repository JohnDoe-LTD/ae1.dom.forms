...
// Enunciado 1
// Se quiere generar una página web completamente por JavaScript, modificando el árbol DOM. La página web
//solo tendrá un contenedor (DIV) y sobre dicho contenedor y por medio de JavaScript se añadirán elementos
//a dicho contenedor. La temática de la web se deja libre al alumno. No es necesario usar CSS. Se valorará usar
...
function cargar() {
    ...
    //Nodo de tipo text
    let textimagen = document.createTextNode("Aquí van dos imágenes de mis comidas favorita:");

    //Configuración del input añadiendo atributos
    img1.setAttribute("src", "https://queapetito.com/wp-content/uploads/2019/02/IMG_3896-600x469.jpg");
    img1.setAttribute("width", "200");

    img2.setAttribute("src", "https://img.europapress.es/fotoweb/fotonoticia_20220808081246_1200.jpg");
